        ...
        <div class="relative overflow-hidden bg-white dark:bg-black py-16">
            ...
            <div class="relative px-6 lg:px-8">
                <div class="mx-auto max-w-prose text-lg">
                    ...
                    <p class="mt-8 text-xl leading-8  text-gray-500 dark:text-gray-400">Aliquet nec orci mattis amet
                        quisque ullamcorper
                        neque,
                ...
                <div
                    class="prose prose-lg prose-indigo dark:prose-invert mx-auto mt-6 text-gray-500 dark:text-gray-400">
                    ...
                    <p>Id orci tellus laoreet id ac. Dolor, aenean leo, ac etiam consequat in. Convallis arcu ipsum urna
                        ...
                        pellentesque id sed tellus mauris, ultrices mauris. Tincidunt enim cursus ridiculus mi. Pellentesque nam sed
                    ...
                    <figure>
                        <img class="w-full rounded-lg" src="/images/cover.webp" alt="About" title="about" width="1200"
                    ...
                    <p>Purus morbi dignissim senectus mattis <a href="#">adipiscing</a>. Amet, massa quam varius orci
                        ...
                        ut viverra ridiculus non molestie. Gravida quis fringilla amet eget dui tempor dignissim. Facilisis
